...
java -javaagent:${JAVA_AGENT}  -cp ${ASPECTS_JAR}:target/classes:target/test-classes:lib/junit-4.10.jar:lib/pitest-1.1.11-SNAPSHOT.jar:lib/pitest-command-line-1.1.10.jar  \
